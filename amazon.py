...
st.markdown("This app is just for learning purposes and experiments, displaying sentiment upon a limited number of clothing products in Amazon.com only. The main purpose is to show that one can build from a simple realtime customer sentiment dashboard to a product search and sentiment comparison dashboard app by using a deep learning model. &nbsp;")
